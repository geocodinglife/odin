...
export default class AlertaIniciarSesion extends HTMLElement {
    ...
    connectedCallback() {
        Promise.resolve(AlertaIniciarSesion.components()).then(html => {
...
customElements.define(name, AlertaIniciarSesion);
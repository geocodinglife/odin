...
export default class creadoExitosamente extends HTMLElement {
    ...
    connectedCallback() {
        Promise.resolve(creadoExitosamente.components()).then(html => {
...
customElements.define(name, creadoExitosamente);
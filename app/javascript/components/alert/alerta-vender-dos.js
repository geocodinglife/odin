...
export default class AlertaVenderDos extends HTMLElement {
    ...
    connectedCallback() {
        Promise.resolve(AlertaVenderDos.components()).then(html => {
...
customElements.define(name, AlertaVenderDos);